...
public class ShowArticles extends AppCompatActivity implements View.OnClickListener{
    ...
    String url = "https://newsapi.org/v2/articles", apiKey = "54910d5eabc54c46a22585618a6d5c85";
    ...
    private void generateArticlesOnScreen() {
        ...
        ArticlesAdapter adapter = new ArticlesAdapter(this, R.layout.activity_layout, articlesArrayList);
